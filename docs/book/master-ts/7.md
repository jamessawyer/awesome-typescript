...
![DeepPromiseValueType](./imgs/7-1.webp)
...
![Included 4](./imgs/7-5.webp)

对 `any` 类型：✅

![Includes 6](./imgs/7-8.webp)
...
- 类型参数 Length 为数组长度，约束为 number。类型参数 Elm 为元素类型，默认值为 unknown。类型参数 Arr 为构造出的数组，默认值是 []。
