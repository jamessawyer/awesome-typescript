import{_ as s,c as n,o as a,b as l}from"./app.437f1f4b.js";const A=JSON.parse('{"title":"Modules class","description":"","frontmatter":{"title":"Modules class"},"headers":[],"relativePath":"ts/dfile/templates/modules-class.md","lastUpdated":1677552034000}'),p={name:"ts/dfile/templates/modules-class.md"},e=l(`<nav class="table-of-contents"><ul></ul></nav><p>例如，当你想使用的JavaScript代码如下：</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> Greeter </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#82AAFF;">require</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">super-greeter</span><span style="color:#89DDFF;">&#39;</span><span style="color:#A6ACCD;">)</span></span>
