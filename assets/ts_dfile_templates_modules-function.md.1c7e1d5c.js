import{_ as s,c as n,o as a,N as l}from"./chunks/framework.8a34944b.js";const f=JSON.parse('{"title":"Module Function","description":"","frontmatter":{"title":"Module Function"},"headers":[],"relativePath":"ts/dfile/templates/modules-function.md","lastUpdated":1679368403000}'),p={name:"ts/dfile/templates/modules-function.md"},e=l(`<nav class="table-of-contents"><ul></ul></nav><p>例如，当你想使用的JavaScript代码如下：</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;font-style:italic;">import</span><span style="color:#A6ACCD;"> greeter </span><span style="color:#89DDFF;font-style:italic;">from</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">super-greeter</span><span style="color:#89DDFF;">&#39;</span></span>
