import{_ as s,c as n,o as a,N as l}from"./chunks/framework.8a34944b.js";const A=JSON.parse('{"title":"Global Modify Module","description":"","frontmatter":{"title":"Global Modify Module"},"headers":[],"relativePath":"ts/dfile/templates/global-modify-module.md","lastUpdated":1679536477000}'),p={name:"ts/dfile/templates/global-modify-module.md"},o=l(`<nav class="table-of-contents"><ul><li><a href="#全局修改模块">全局修改模块</a></li><li><a href="#识别全局修改模块">识别全局修改模块</a></li></ul></nav><h2 id="全局修改模块" tabindex="-1">全局修改模块 <a class="header-anchor" href="#全局修改模块" aria-label="Permalink to &quot;全局修改模块&quot;">​</a></h2><p><code>全局修改模块（global-modifying modules）在导入时修改全局作用域中的现有值。</code> 比如，可能存在一个模块在导入时给 <code>String.prototype</code> 添加新的成员。这种模式可能很危险，可能导致运行时冲突😅，但是我们仍可给它写一个声明文件。</p><h2 id="识别全局修改模块" tabindex="-1">识别全局修改模块 <a class="header-anchor" href="#识别全局修改模块" aria-label="Permalink to &quot;识别全局修改模块&quot;">​</a></h2><p>全局修改模块一般很容易从它的文档中进行识别。通常，它们类似于全局插件，但是需要 <code>require</code> 调用激活它们的副作用。</p><p>你可能看到它们的文档是这样的：</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line highlighted"><span style="color:#676E95;font-style:italic;">// &#39;require&#39; 调用，但不使用其返回值😅</span></span>
