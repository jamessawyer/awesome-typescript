import{_ as s,c as n,o as a,d as l}from"./app.a2f7fa70.js";const f=JSON.parse('{"title":"Module Function","description":"","frontmatter":{"title":"Module Function"},"headers":[],"relativePath":"ts/dfile/templates/modules-function.md","lastUpdated":1676788701000}'),p={name:"ts/dfile/templates/modules-function.md"},e=l(`<nav class="table-of-contents"><ul></ul></nav><p>例如，当你想使用的JavaScript代码如下：</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#89DDFF;font-style:italic;">import</span><span style="color:#A6ACCD;"> greeter </span><span style="color:#89DDFF;font-style:italic;">from</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">super-greeter</span><span style="color:#89DDFF;">&#39;</span></span>
...
<span class="line"></span></code></pre></div><p>原文档：</p><ul><li><a href="https://www.typescriptlang.org/docs/handbook/declaration-files/templates/module-function-d-ts.html" target="_blank" rel="noreferrer">Module: Function</a></li></ul><p>2022年09月03日12:59:20</p>`,8),o=[e];function t(c,r,i,y,F,D){return a(),n("div",null,o)}const d=s(p,[["render",t]]);export{f as __pageData,d as default};
